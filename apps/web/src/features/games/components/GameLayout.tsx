...
export function GameLayout({ header, players, timeline, debug }: GameLayoutProps) {
  return (
    <main
      className="game-detail-workbench mx-auto grid w-full max-w-none gap-4 px-4 py-6 lg:grid-cols-[20rem_minmax(0,1fr)_22rem]"
      data-testid="game-detail-workbench"
    >
