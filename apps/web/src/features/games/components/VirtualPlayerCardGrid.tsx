...
export function VirtualPlayerCardGrid({
  ...
  return (
    <div className="virtual-player-library-browser">
      <aside
        aria-label="虚拟玩家筛选"
        className="virtual-player-library-filter-rail"
      >
        <div className="virtual-player-filter-heading">虚拟玩家库</div>
        {actionError ? (
      ...
      <div className="virtual-player-library-card-matrix">
        {!isLoading && !isError && profiles.length === 0 ? (
          <p className="virtual-player-library-empty">还没有保存的虚拟玩家。</p>
        ) : null}
        {profiles.length > 0 && filteredProfiles.length === 0 ? (
          <p className="virtual-player-library-empty">
            没有符合条件的虚拟玩家。
          </p>
        ) : null}
                ...
                <li className="virtual-player-card" key={profile.id}>
                  ...
                  <div className="virtual-player-card-main">
                    <div className="virtual-player-card-heading">
                      ...
                      {profile.favorite ? (
                        <span className="virtual-player-card-favorite">
                          收藏
                        </span>
                      ) : null}
