...
JUDGE_VOICE_LINES: tuple[JudgeVoiceLine, ...] = (
    ...
    JudgeVoiceLine("exile_tie", "放逐投票出现平票，进入 PK 环节。", "放逐"),
    JudgeVoiceLine("exile_pk_start", "平票候选人依次进行 PK 发言。", "放逐"),
    JudgeVoiceLine(
        "exile_runoff_vote",
        "PK 发言结束，除 PK 玩家外的玩家开始二轮投票。",
        "放逐",
    ),
    JudgeVoiceLine(
        "exile_runoff_tied",
        "二轮投票仍为平票，本轮无人被放逐，直接进入夜晚。",
        "放逐",
    ),
    JudgeVoiceLine("exile_no_votes", "本轮没有形成有效投票，无人被放逐。", "放逐"),
    JudgeVoiceLine(
        "exile_no_result",
        "放逐投票未产生出局玩家，本轮无人被放逐。",
        "放逐",
