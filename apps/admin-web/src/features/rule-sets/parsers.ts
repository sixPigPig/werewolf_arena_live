...
const WEREWOLF_ATTACK_RESOLUTIONS: readonly RuleWerewolfAttackResolution[] = ["plurality_rotating_tiebreak", "plurality_seeded_random", "unanimous_no_attack"];
...
export function parseRuleSetOptions(value: unknown): RuleSetOptions {
  ...
  return {
    ...
    werewolf_attack_resolutions: choices(r.werewolf_attack_resolutions, "werewolf_attack_resolutions", WEREWOLF_ATTACK_RESOLUTIONS),
