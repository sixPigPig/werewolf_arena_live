...
export const contractGameDetail: AdminGameDetail = {
  ...
  quality_evaluation: {
    ...
    source_revision: "source-revision-fixture-001",
    created_at: "2026-07-10T01:03:01Z",
    started_at: "2026-07-10T01:03:02Z",
    completed_at: "2026-07-10T01:04:00Z",
    attempt_count: 2,
    failure_reason: null,
    can_retry: false,
    ...
    liveness: {
      ...
      public_speech_count: 8,
      timing_coverage: {
        first_clause_committed_at: { count: 8, denominator: 8, rate: 1 },
      },
      stage_latency_ms: {
        renderer_to_first_delta: { count: 8, p50: 420, p95: 780, max: 900 },
        first_delta_to_clause: { count: 8, p50: 90, p95: 180, max: 220 },
      },
      prompt_chars: { count: 8, p50: 920, p95: 1080, max: 1120 },
      hard_gate_duration_ms: { count: 8, p50: 2, p95: 6, max: 8 },
      hard_retry_count: 0,
      hard_retry_rate: 0,
      hard_exhausted_count: 0,
      hard_exhausted_rate: 0,
      partial_speech_count: 0,
      interrupted_speech_count: 1,
      voice_timing_coverage: {
        tts_started_at: 8,
        first_audio_chunk_at: 8,
        denominator: 8,
      },
      tts_to_first_audio_ms: { count: 8, p50: 310, p95: 620, max: 700 },
      turn_to_first_audio_ms: { count: 8, p50: 880, p95: 1400, max: 1650 },
      voice_status_counts: { complete: 8 },
      playback_timing_coverage: {
        playback_started_at: 8,
        playback_finished_at: 8,
        ack_received_at: 8,
        denominator: 8,
      },
      playback_status_counts: { completed: 7, interrupted: 1 },
      speaker_gap_ms: { count: 7, p50: 420, p95: 760, max: 900 },
      actor_mind: {
        snapshot_count: 8,
        update_count: 34,
    ...
    critical_actions: [
      {
        schema_version: 1,
        action_id: "action_contract_vote_1",
        round_number: 1,
        action: "vote",
