...
function detail(stopped: boolean) {
  ...
  return {
    ...
    match_status: stopped ? "canceled" : "running",
    execution_state: stopped ? "stopped" : "owned",
    winner: null,
    completion_reason: stopped ? "operator_interrupted" : null,
    ...
    runs: [
      {
        ...
        worker_id: stopped ? null : "v2-worker-control",
        worker_heartbeat_at: stopped ? null : now,
        lease_expires_at: stopped ? null : "2026-07-25T09:00:30Z",
        fence_token: stopped ? 3 : 2,
      },
    ],
    presentations: [],
    voice_assets: [],
